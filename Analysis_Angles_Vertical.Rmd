...
```{r Load data}
data <- read.csv('Data_Vertical.csv', stringsAsFactors=TRUE)
```
...
```{r Save results}
write.csv(results_1HA, "Results_Vertical_Up_HA.csv", row.names=FALSE)
write.csv(results_1LA, "Results_Vertical_Up_LA.csv", row.names=FALSE)
write.csv(results_2HA, "Results_Vertical_Down_2HA.csv", row.names=FALSE)
write.csv(results_2LA, "Results_Vertical_Down_2LA.csv", row.names=FALSE)
```
